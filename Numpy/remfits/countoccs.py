...
# This program generates rows of a latex table from some results generated by dblcurvegen
...
parsearg = argparse.ArgumentParser(description='Tabulate first 3 occs in tables from dblcurvegen', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
