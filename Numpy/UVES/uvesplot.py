...
parsearg = argparse.ArgumentParser(description='Process UVES data and show plots of effectively suppressing where X-ray levels are high', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
